...
// Add these functions for arrow button movements
...
function moveUp() {
  // Implement your logic for moving tiles up
  directions({ keyCode: "38" });
}

function moveDown() {
  // Implement your logic for moving tiles down
  directions({ keyCode: "40" });
}

function moveLeft() {
  // Implement your logic for moving tiles left
  directions({ keyCode: "37" });
}

function moveRight() {
  // Implement your logic for moving tiles right
